...
CASES = [
    ...
    #   NetworkAddress: Data(02 00 00 00 C0 A8 04 2D ...)
    # sin_family = 2 (LE u16), sin_port = 0, sin_addr = 192.168.4.45. Byte 1 is 0x00 here, which
    # is what the unpatched code choked on.
    ("linux ipv4 (real netmuxd capture)",
     [0x02, 0x00, 0x00, 0x00, 0xC0, 0xA8, 0x04, 0x2D] + [0x00] * 20, "inet"),

    # What a macOS AltServer sees: sa_len = 16, sa_family = AF_INET = 2.
    ("bsd ipv4",
     [0x10, 0x02, 0x00, 0x00, 0xC0, 0xA8, 0x04, 0x2D] + [0x00] * 20, "inet"),
